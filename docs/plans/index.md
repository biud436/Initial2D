...
| 검수 인프라 | 🟡 진행 중 | 2026-08-15 | 핵심 완료: C++ 단위(7), Lua 단위(64), 골든 2장, run_all.sh, 헤드리스, CI 통과(골든 오차 실측 보정 1%→2%). 전체 21 PASS / 0 FAIL. 남은 것: 입력 재생기, 맵 픽스처(2단계 대기) |
