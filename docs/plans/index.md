...
| 타일맵 | 죽은 코드만 존재 (`src/Tilemap.cpp`는 미사용에 버그, `scripts/tilemap.lua`는 데모 수준) | 사실상 전부 |
...
| 단계 | 상태 | 마지막 갱신 | 메모 |
|---|---|---|---|
| 1. 엔진 코어 보강 | 🟡 진행 중 | 2026-08-15 | GetTextWidth, Json.Load, SetSheetGrid, Dispose 완료. Font와 GetRect, Rectangle 버그 5건 수정. 남은 것: 논리 해상도 설정, PlayMusic 루프 플래그 |
| 2. 타일맵 시스템 | ⬜ 대기 | 2026-08-15 | |
| 3. 에디터 브리지 | ⬜ 대기 | 2026-08-15 | |
| 4. 리소스 어댑터 | ⬜ 대기 | 2026-08-15 | |
| 5. 캐릭터와 이동 | ⬜ 대기 | 2026-08-15 | |
| 6. 이벤트와 상호작용 | ⬜ 대기 | 2026-08-15 | |
| 7. 대화창과 UI | ⬜ 대기 | 2026-08-15 | |
| 8. 통합 데모 | ⬜ 대기 | 2026-08-15 | |
| 검수 인프라 | 🟡 진행 중 | 2026-08-15 | 완료: C++ 단위, Lua 단위, 골든, run_all.sh, 헤드리스, CI, 입력 재생기. 남은 것: 맵 픽스처뿐(2단계 포맷 확정 대기)이므로 사실상 완료 |
