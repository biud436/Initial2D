...
| 구간 | 선율 중앙 | 관찰 |
|---|---|---|
| 벌스 1·2 | **A3** | 낮게 읊조리는 테시투라 |
| 후렴 1·큰후렴 | **B3** (+2반음) | 완만한 상승 |
| 마지막 후렴(전조) | **D4** (+5반음) | 최종 상승 — 새 으뜸음 위에 안착 |

음역은 대략 C3~A4(약 1.5옥타브). 후렴에서 가수를 위로 몰아붙이는 대신 **최종 상승분을
전조에서 얻는** 설계라, 목소리의 무리 없이 누적 상승감을 만든다. (검출된 G5 극고음은
기악 성부 또는 배음 오검출 가능성이 높아 보컬 상한으로 보지 않는다.)
