...
PROFILE = [
    ...
    (44, 55, 24, 15),       # 방으로 트인다
    # 달의 방: 넓고, 바닥에 단이 여럿.
    # **한 단은 두 타일을 넘기지 않는다.** 점프가 53px(3.3타일), 2단까지 87px인데
    # 미끄러운 바닥에서 도움닫기가 줄기 때문이다. 처음에 25→20의 다섯 타일 벽을
    # 두었더니 자율 봇이 거기서 막혔다 (인수 시나리오가 잡아냈다).
    (56, 71, 25, 10),
    (72, 77, 24, 10),
    (78, 85, 22, 10),
    (86, 91, 23, 10),
    ...
    (156, 167, 26, 8),
    (168, 183, 24, 12),
    # 파괴의 방: 무너진 바닥. 구덩이 둘. 여기도 단은 두 타일까지
    (184, 199, 24, 9),
    (200, 209, 26, 9),
    (210, 215, 25, 9),
    (216, 225, 23, 9),
...
# 석관 2x2 (x, 윗줄 y)
SARCOPHAGI = [(80, 20), (102, 18), (170, 22), (296, 23)]
