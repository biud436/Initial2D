...
-- System(대화창 스킨): 160x80. 세부 분할은 7단계에서 확정하되, 실측으로
-- 확인한 것만 적어 둔다 (System.png를 16x16 격자로 덮어 확인, 2026-08-16).
M.window = {
	skinW = 160, skinH = 80,
	background = { x = 0, y = 0, w = 32, h = 32 },    -- 창 바탕 (늘리거나 반복)
	frame = { x = 32, y = 0, w = 32, h = 32 },        -- 테두리 (모서리 8px)
	frameCorner = 8,
	cursor = { x = 64, y = 0, w = 32, h = 32 },       -- 선택 커서
	cursor2 = { x = 96, y = 0, w = 32, h = 32 },      -- 깜빡임용 두 번째 커서
	arrows = { x = 128, y = 0, w = 32, h = 32 },      -- 스크롤 화살표 4개 (16x16)
